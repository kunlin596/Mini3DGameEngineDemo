...
public class WaterFrameBuffers {
    ...
    public WaterFrameBuffers() {//call when loading the game
        ...
        // 1) color buffer texture attachment and a depth buffer texture attachment
        // 2) color buffer attachment and a depth buffer renderer buffer attachment
    ...
    // Tell OpenGL we want to render to our own frame buffer
    ...
    private int createFrameBuffer() {
        ...
        // Tells OpenGL which buffer attachment we are going to render to.
    ...
    private int createTextureAttachment(int width, int height) {
        ...
        // Use the frame buffer to create a texture
